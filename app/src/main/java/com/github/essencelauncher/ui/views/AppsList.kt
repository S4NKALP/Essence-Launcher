...
import com.github.essencelauncher.utils.PrivateAppItem
import com.github.essencelauncher.utils.PrivateSpaceSettings
import com.github.essencelauncher.utils.doesPrivateSpaceExist
import com.github.essencelauncher.utils.getAppsAlignment
import com.github.essencelauncher.utils.getBooleanSetting
import com.github.essencelauncher.utils.getPrivateSpaceApps
import com.github.essencelauncher.utils.lockPrivateSpace
import com.github.essencelauncher.utils.openPrivateSpaceApp
import com.github.essencelauncher.utils.showPrivateSpaceAppInfo
import com.github.essencelauncher.utils.uninstallPrivateSpaceApp
import com.github.essencelauncher.utils.unlockPrivateSpace
import com.github.essencelauncher.MainAppViewModel as MainAppModel
import com.github.essencelauncher.utils.isPrivateSpaceUnlocked as isPrivateSpace
...
fun AppsList(
    ...
    Box(
        ...
        LazyColumn(
                    ...
                    AnimatedPillSearchBar(
                        textChange = { searchBoxText ->
                            ...
                            filteredApps = filteredApps.filter { appInfo ->
                                !appInfo.packageName.contains("com.github.essencelauncher")
                            }
            ...
            { app ->
                // Draw app if its not hidden and not Essence itself
                if (!app.packageName.contains("com.github.essencelauncher") && !mainAppModel.hiddenAppsManager.isAppHidden(
                        app.packageName
                    )
                ) {
                    HomeScreenItem(
