...
/**
 * Returns if the default launcher is essence launcher
 */
fun isDefaultLauncher(context: Context): Boolean {
    val launcherPackageName = getDefaultLauncherPackage(context)
    return "com.github.essencelauncher" == launcherPackageName || "com.github.essencelauncher.dev" == launcherPackageName
}
